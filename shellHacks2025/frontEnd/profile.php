    ...
    <div class="profile-container">
        ...
        <form method="POST" action="" class="profile-form">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="<?php if (isset($_SESSION['username']))  echo htmlspecialchars($profile_data['name']); ?>" required>
            </div>

            <div class="form-group">
                <label for="age">Age:</label>
                <input type="number" id="age" name="age" value="<?php if (isset($_SESSION['username'])) echo htmlspecialchars($profile_data['age']); ?>" min="1" max="120" required>
            </div>
            ...
            <div class="form-group">
                <button type="submit" id="saveButton" class="btn btn-primary" disabled>Save Profile</button>
            </div>
        </form>
        <?php } else { ?>
